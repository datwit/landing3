...
export { default as Collapsible } from '../..\\components\\global\\Collapsible.vue'
export { default as Cta } from '../..\\components\\global\\CTA.vue'
export { default as Iconblock } from '../..\\components\\global\\Iconblock.vue'
...
export { default as Faqs } from '../..\\components\\partner\\Faqs.vue'
...
export { default as Selection } from '../..\\components\\home\\Selection.vue'
export { default as Services } from '../..\\components\\home\\Services.vue'

export const LazyAuthor = import('../..\\components\\global\\Author.vue' /* webpackChunkName: "components_global/Author" */).then(c => c.default || c)
export const LazyCollapsible = import('../..\\components\\global\\Collapsible.vue' /* webpackChunkName: "components_global/Collapsible" */).then(c => c.default || c)
export const LazyCta = import('../..\\components\\global\\CTA.vue' /* webpackChunkName: "components_global/CTA" */).then(c => c.default || c)
export const LazyIconblock = import('../..\\components\\global\\Iconblock.vue' /* webpackChunkName: "components_global/Iconblock" */).then(c => c.default || c)
...
export const LazyScrollsign = import('../..\\components\\global\\Scrollsign.vue' /* webpackChunkName: "components_global/Scrollsign" */).then(c => c.default || c)
...
export const LazyFaqs = import('../..\\components\\partner\\Faqs.vue' /* webpackChunkName: "components_partner/Faqs" */).then(c => c.default || c)
...
export const LazySelection = import('../..\\components\\home\\Selection.vue' /* webpackChunkName: "components_home/Selection" */).then(c => c.default || c)
export const LazyServices = import('../..\\components\\home\\Services.vue' /* webpackChunkName: "components_home/Services" */).then(c => c.default || c)
