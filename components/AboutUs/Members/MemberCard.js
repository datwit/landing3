...
const MemberCard = ({name, designation, rol, twitter, linkedin, github}) => {
    ...
    return (
        <>
            <img alt="team" className="flex-shrink-0 rounded-lg h-80 object-cover object-center" src="" />
            <div onMouseEnter={toggleHoverON} onMouseLeave={toggleHoverOFF}>
                <div className={hover ? "" : "h-8 overflow-hidden"}>
