<template>
  <section class="bg-white mx-auto max-w-screen-xl">
    ...
    <div class="container px-5 mx-auto">
        ...
        <h4 class="mb-6">Whatever cardigan tote bag tumblr hexagon brooklyn asymmetrical gentrify, subway tile poke farm-to-table. Franzen you probably haven't heard of them.</h4>
      <div class="hidden md:block">
        <div class="flex flex-wrap -m-4">
          <div class="p-4 sm:w-1/3 lg:w-1/5 w-1/2">
          ...
          <!---------------------------------------------------------------------------------->
          <div class="p-4 sm:w-1/2 lg:w-1/5 w-1/2">
            <div class="h-full flex flex-col items-center text-center">
              <img alt="team" class="flex-shrink-0 rounded-lg w-40 h-40 object-cover object-center mb-4" src="https://dummyimage.com/200x200">
              <div class="w-full">
                <h2 class="title-font font-medium text-lg text-gray-900">Alper Kamu</h2>
