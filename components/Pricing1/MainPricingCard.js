...
const MainPricingCard = ({style, field, price, cost, description, children}) => {
    ...
    return (
        <>           
            <FullPricingCard className={`border-${style}`} onMouseEnter={toggleHoverON} onMouseLeave={toggleHoverOFF}>
                ...
                <div className="p-3">
                    <span className="flex justify-center items-baseline my-2"><Price>{price}</Price><p className="m-0"> /months</p></span>
