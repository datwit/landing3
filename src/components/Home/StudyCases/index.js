            ...
            <div className="flex flex-wrap -m-4">          
                <div className="p-4 md:w-1/3">                
                    <div className="h-full border-2 border-gray-200 border-opacity-60 overflow-hidden mx-4 md:mx-0">
                        <img className="lg:h-48 md:h-36 w-full object-cover object-center" src={DATA.CASE1.img} alt={DATA.CASE1.alt} />
                        <div className="p-4">
                            {/* <h2 className="tracking-widest text-xs title-font font-medium text-gray-400 mb-1">CATEGORY</h2> */}
                            <h1 className="title-font text-lg font-bold text-primary mb-3">{DATA.CASE1.title}</h1>
                            <p className="mt-2 text-base leading-6 text-gray-500">{DATA.CASE1.description}</p>
